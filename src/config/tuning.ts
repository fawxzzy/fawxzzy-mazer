...
export const legacyTuning = {
  ...
  menu: {
    ...
    intentFeed: {
      ...
      compactWidthPx: 336,
      minWidthPx: 240,
      compactMinWidthPx: 210,
      maxWidthRatio: 0.34,
      compactMaxWidthRatio: 0.82,
      maxVisibleEntries: 3,
      minHeightPx: 84,
      compactMinHeightPx: 70,
      paddingXPx: 14,
      paddingYPx: 10,
      headerHeightPx: 18,
      compactHeaderHeightPx: 15,
      lineHeightPx: 22,
      compactLineHeightPx: 18,
      entryGapPx: 4,
      headerFontPx: 10,
      compactHeaderFontPx: 9,
      statusFontPx: 14,
      compactStatusFontPx: 12,
      entryFontPx: 13,
      compactEntryFontPx: 11,
      riskFontPx: 11,
      compactRiskFontPx: 10,
      summaryMaxChars: 38,
      compactSummaryMaxChars: 28,
      statusMaxChars: 34,
      compactStatusMaxChars: 26,
      minimumDwellMs: 2080,
      replacementDebounceMs: 860,
      transitionMs: 240,
      ...
      desktopBottomWidthPx: 760,
      desktopBottomMinWidthPx: 480,
      desktopBottomMaxWidthRatio: 0.58,
      microThoughtMinHeightPx: 920,
  ...
  demo: {
    ...
    lifecycle: {
      buildPrerollRatio: 0.22,
      buildRevealStartRatio: 0.08,
      buildRevealEndRatio: 0.94,
      settleInRatio: 0.14,
      clearHoldRatio: 0.34,
      eraseStartRatio: 0.74,
      reducedMotionChunkSize: 4
    },
    behavior: {
      trailMaxLength: 46,
