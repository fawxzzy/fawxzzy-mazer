export const legacyTuning = {
  board: {
    ...
    goalPulse: {
      ...
      ringAlpha: 0.98,
      outerRingAlpha: 0.6,
      glowRadiusRatio: 0.56,
      ringRadiusRatio: 0.31,
      outerRingRadiusRatio: 0.5,
      coreRadiusRatio: 0.16,
      ringWidthRatio: 0.08,
      outerRingWidthRatio: 0.038,
      sparkLengthRatio: 0.24,
      sparkAlpha: 0.62,
      coreHighlightRadiusRatio: 0.078,
      tileHaloAlpha: 0.28
    },
    trail: {
      minAlpha: 0.12,
      ...
      insetRatio: 0.33,
      lineWidthRatio: 0.14,
      glowLineWidthRatio: 0.26,
      glowMinAlpha: 0.18,
      glowMaxAlpha: 0.48,
      nodeRadiusRatio: 0.1,
      headAlphaBoost: 0.24,
      headRadiusRatio: 0.18,
      headPulseAmplitude: 0.12,
      backtrackAlphaScale: 0.42,
      backtrackLineAlphaScale: 0.38,
      backtrackInsetRatio: 0.42,
      backtrackNodeRadiusRatio: 0.078,
      maxLength: 38
    },
    actor: {
      shadowAlpha: 0.62,
      ...
      haloAlpha: 0.46,
      haloRadiusRatio: 0.44,
      coreRadiusRatio: 0.25,
      ringRadiusRatio: 0.31,
      ringWidthRatio: 0.075,
      outerRingRadiusRatio: 0.37,
      outerRingAlpha: 0.42,
      highlightOffsetRatio: 0.08,
      highlightRadiusRatio: 0.065,
      pointerOffsetRatio: 0.2,
